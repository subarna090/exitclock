(function () {
  ...
  function build() {
    ...
    items.push({ date: addDays(lwd, 14), title: "Check what public support you actually qualify for", text: "Check National Career Service for vacancies and counsellors, and ESIC schemes if you were an insured person.", rule: "ESIC's Atal Beemit Vyakti Kalyan Yojana is in force from 1 July 2026 to 30 June 2027 (extended at the 198th ESIC meeting; PIB release 30 June 2026). Eligibility depends on ESI coverage and contribution conditions — confirm your own status on esic.gov.in before planning around it." });
